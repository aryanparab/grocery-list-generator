...
authenticator = Authenticate(
    ...
    redirect_uri=["https://aryanparab-grocery-list-generator-streamlit-app-dxclse.streamlit.app/callback","http://localhost:8501","http://localhost:8501/oauth2callback","https://aryanparab-grocery-list-generator-streamlit-app-dxclse.streamlit.app"],
)
